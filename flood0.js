...
if (process.argv.length < 7) {
    console.log(`Usage: node floodv2 Target Time Requests Thead ProxyFile`.rainbow);
    process.exit();
}
const headers = {};
...
if (cluster.isMaster) {
 ...
 console.log("Staus: ".yellow + "[ Attack Successfully Sent ]".rainbow);
 console.log("TarGet: ".yellow + "[" + process.argv[2].rainbow + "]");
 console.log("Thead: ".yellow + "[" + process.argv[5].rainbow + "]");
 console.log("Time: ".yellow + "[" + process.argv[3].rainbow + "]");
 console.log("Requests: ".yellow + "[" + process.argv[4].rainbow + "]");
console.log(`[36m ProxyFile :[0m ${args.proxyFile} | [36m Total:[0m ${proxies.length}`);
